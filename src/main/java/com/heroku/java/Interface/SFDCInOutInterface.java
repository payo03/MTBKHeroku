...
public class SFDCInOutInterface {
    ...
    public Map<String, Object> kakaoAlim(@RequestHeader(value = "X-API-KEY", required = true) String apiKey,
         ...
         * JsonNode destinations =
         * jsonNode.path("messages").get(0).path("destinations");
         * // WHITE LIST ON_OFF
         ...
         * resultMap.put("message", "The destination number " + destination +
    ...
    public Map<String, Object> fetchTemplate(@RequestHeader(value = "X-API-KEY", required = true) String apiKey,
            @ModelAttribute FetchTemplateRequest request) throws Exception {
        Map<String, Object> resultMap = new HashMap<String, Object>();
        resultMap.put("code", true);
        resultMap.put("message", "Great. you\'ve got " + ((int) (Math.random() * 100)) + " points");
        logger.info(request);
    ...
    @PostMapping("/pages")
    public Integer getPageNumber(@RequestHeader(value = "X-API-KEY", required = true) String apiKey,
            @RequestBody String file) throws UnsupportedEncodingException {
     ...
     * public Map<String, Object> asyncSMS004(@RequestHeader(value="X-API-KEY",
     * required = true) String apiKey, @RequestBody String jsonString) throws
     * Exception {
     * logger.info("\n{}", jsonString);
     * 
     * Map<String, Object> resultMap = new HashMap<String, Object>();
     * resultMap.put("code", true);
     * resultMap.put("message", "Great. you\'ve got " + ((int) (Math.random() *
     * 100)) + " points");
     * 
     ...
     * UriComponentsBuilder URIBuilderSAP =
     * UriComponentsBuilder.fromHttpUrl(SAP_URL)
     ...
     * ;
     * UriComponentsBuilder URIBuilderSFDC =
     * UriComponentsBuilder.fromHttpUrl(SFDCURL)
     ...
     * .pathSegment(PATH_ES004);
     * 
     * asyncService.AsyncDoCallOutSAP(String.class, URIBuilderSAP, URIBuilderSFDC,
     * requestEntity, idList);
     * return resultMap;
     * }
     * 
     ...
     * 
     * @SuppressWarnings("unchecked")
     * public Map<String, Object> asyncSMS009(@RequestHeader(value="X-API-KEY",
     * required = true) String apiKey, @RequestBody String jsonString) throws
     * Exception {
     * logger.info("\n{}", jsonString);
     * 
     ...
     * 
     * @SuppressWarnings("unchecked")
     * public Map<String, Object> asyncSMS010(@RequestHeader(value="X-API-KEY",
     * required = true) String apiKey, @RequestBody String jsonString) throws
     * Exception {
     * logger.info("\n{}", jsonString);
     * 
     ...
     * 
     * @SuppressWarnings("unchecked")
     * public Map<String, Object> asyncSMS011(@RequestHeader(value="X-API-KEY",
     * required = true) String apiKey, @RequestBody String jsonString) throws
     * Exception {
     * logger.info("\n{}", jsonString);
     * 
